...
## ⚠ Support note ⚠:
I will be updating this CSS for the latest version of Firefox ESR, (Might Change), if you want to install it on older versions feel free to use [Wilfredwee's Version](https://github.com/wilfredwee/photon-australis)
